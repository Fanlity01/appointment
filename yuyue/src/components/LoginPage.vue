        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    <h3>加入我们</h3>
                    <p>加入我们，成为本站的一份子。</p>
                    <button class="btn transparent" id="sign-up-btn" @click="togglePanel">去注册</button>
                </div>
            ...
            <div class="panel right-panel">
                <div class="content">
                    <h3>已有帐号？</h3>
                    <p>立即登录已有帐号，享受独家权益。</p>
                    <button class="btn transparent" id="sign-in-btn" @click="togglePanel">去登录</button>
                </div>
...
const handleLogin = async () => {
    try {
        ...
        if (response.data.code == 200) {
            localStorage.setItem('token', newToken); // 更新保存的token
            router.push('/home');
        } else {
